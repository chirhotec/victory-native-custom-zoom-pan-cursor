...
import { NativeHelpers, Portal } from "victory-native";
...
export default class extends VictoryContainer {
  ...
  handleResponderGrant(evt) {
    console.log("***** handleResponderGrant", evt.currentTarget);
  ...
  handleResponderMove(evt) {
    console.log("***** handleResponderMove", evt.currentTarget);
  ...
  handleResponderEnd(evt) {
    console.log("***** handleResponderEnd", evt.currentTarget);
